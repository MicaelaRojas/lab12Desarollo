	 	 	 ...
	 	 	 <div class="panel panel-default">
	 	 	 	 ...
	 	 	 	 <div class="panel-body">	 	 	 	 	 
	 	 	 	 	 ...
	 	 	 	 	 <div class="table-container">
	 	 	 	 	 	 <form method="POST" action="{{ route('venta.store') }}" role="form">
	 	 	 	 	 	 	 {{ csrf_field() }}
<div class="row">
...
<div class="row">
	 	 	 	 	 	 	 	 <div class="col-xs-6 col-sm-6 colmd-6">
	 	 	 	 	 	 	 	 	 <div class="form-group">
	 	 	 	 	 	 	 	 	 	 <input type="date"
name="fecha" id="fecha" class="form-control input-sm" placeholder="Fecha">
	 	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 	 </div>
<div class="col-xs-6 col-sm-6 colmd-6">
	 	 	 	 	 	 	 	 	 ...
	 	 	 	 	 	 	 	 	 <div class="form-group">
	 	 	 	 	 	 	 	 	 	 <input type="text"
name="tipo_pago" id="tipo_pago" class="form-control input-sm" placeholder="Tipo de pago">
	 	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 </div>
<div class="row">
<div class="col-xs-12 col-sm-6 colmd-6">	 	
								   <div class="form-group">
	 	 	 	 	 	 	 	 	 	 <input type="text"
name="monto" id="monto" class="form-control input-sm" placeholder="Monto total">
	 	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 	 </div>
	 	 	 	 	 	 	 </div>
<div class="row">
